    ...
    export const subcategory = (sub) =>
{
    return async (dispatch) =>
    {
        ...
        .catch((error)=>
        {
            dispatch({type:`${ProductConst.PRODUCT_SUBCATAGORY}_FAIL`});
        })
...
export const productdetails = (pid) =>
{
    ...
    .then((res)=>{
        ...
        dispatch({type:`${ProductConst.PRODUCT_DETAILS}_SUCCESS`,payload:{data:pdata}});
    })
    .catch((error)=>{
        dispatch({type:`${ProductConst.PRODUCT_DETAILS}_FAIL`});
    })
    }
